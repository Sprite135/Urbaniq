        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneOtpHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneOtpExpiresUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PhoneOtpFailedAttempts = table.Column<int>(type: "int", nullable: false),
                    PhoneOtpLockedUntilUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EmailVerificationTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailVerificationTokenExpiresUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresConfiguration = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Size = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Color = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AvailableSizes = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    AvailableColors = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    DeliverableZones = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryZone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PcSpecifications_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnRequestedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReplacementRequestedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PcSpecifications_ProductId_SpecKey",
                table: "PcSpecifications",
                columns: new[] { "ProductId", "SpecKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PcSpecifications_SpecKey",
                table: "PcSpecifications",
                column: "SpecKey");

            migrationBuilder.CreateIndex(
                name: "IX_PcSpecifications_SpecValue",
                table: "PcSpecifications",
                column: "SpecValue");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_SubCategoryId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_TotalSold_CreatedAtUtc",
                table: "Products",
                columns: new[] { "TotalSold", "CreatedAtUtc" });
